...
<!-- rn:theme path="/euf/assets/themes/standard" css="ask-new-design-ie.css" / -->
...
<div class="csp-wrapper"> <!-- csp-wrapper -->
  ...
  <ul class="csp-teaser-list">
    <li><span>You can also refer to our <a href="https://www.mynamenecklace.ie/Article.aspx?p=5058&source=CustomerSupport" target="_top">FAQ</a> for quick answers for most questions.</span></li>
    <li><span>To follow up on your order, please visit the <a href="https://www.mynamenecklace.ie/ordertracking.aspx?source=CustomerSupport" target="_top">Order Tracking Information</a>.</span></li>
  </ul>
  <hr class="CShr">
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-input-full csp-category">
        <rn:widget path="custom/input/CustomProductCategoryInput" name="Incident.Category" required_lvl="1" category_id_key="CUSTOM_CFG_CATEGORIES_LIST_IE"/>
      </div>
      <!-- /CATEGORY -->
