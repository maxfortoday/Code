...
<div class="csp-wrapper"> <!-- csp-wrapper -->
  <div class="csp-teaser" style="margin-top: 20px;">
    ...
    <p class="csp-input-right">
      <img class="dhl-img" src="https://mnn.custhelp.com/euf/assets/themes/standard/images/dhl-fedex-ups-usps.jpg" />
    </p>
  </div>
  <hr class="CShr">
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-lang-wrap">
        <rn:widget path="input/SelectionInput" name="Incident.c$site" default_value="91" />
      </div>
      <!-- /LANG -->
