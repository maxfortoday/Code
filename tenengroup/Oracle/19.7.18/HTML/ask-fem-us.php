...
<div class="csp-wrapper"> <!-- csp-wrapper -->
  <div class="fem-cs-wrapper">
    ...
    you. Simply fill out the form below, and we’ll respond as soon as possible. 
      <ul class="CSList">
       <li><span>Check out our <a href="https://www.forevermom.com/Article.aspx?p=5555&source=emailus" target="_top">HELP CENTER</a> for answers to the most commonly asked questions.</span></li>
       <li><span>Visit our simple <a href="https://www.forevermom.com/OrderTracking.aspx?source=emailus" target="_top">Order Tracking page</a> to follow up on your purchase’s status.</span></li>
      </ul>
      <hr />
    </div>
  </div>
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-input-full csp-category">
        <rn:widget 
          path="custom/input_fem_us/CustomProductCategoryInput" 
          name="Incident.Category" 
          required_lvl="1" 
          category_id_key="CUSTOM_CFG_CATEGORIES_LIST_FEMUS"/>
      </div>
...
<!-- user's chosen update from JS -->
      ...
      <div class="csp-input-left csp-phone">
        <rn:widget 
          path="custom/FormInput_fem_us/mnnFormInput" 
      ...
      <div class="csp-input-right csp-state">
        <rn:widget 
          ...
          required="false" 
          label_input="#rn:msg:CUSTOM_MSG_STATE_EN#"/>
...
<option value="Vietnam">Vietnam</option>
      ...
      <div class="csp-input-right csp-zip">
        <rn:widget 
          ...
          required="false" 
          label_input="#rn:msg:CUSTOM_MSG_ZIP_CODE_EN#"/>
...
?>
      ...
      <!--label for="rn_FileAttachmentUpload_18_FileInput">
        ...
        <div id="rn_fileAttachName" class="FormInputErrorPlaceholder" style="display:none">
          <div class="FormInputErrorPlaceholder"><div><b><a> Attached Document is required</a></b></div></div>
        </div-->
      </div>
      <!-- /FILE UPLAOD -->
      ...
      <div class="csp-submit">
        <rn:widget 
          path="custom/FormSubmit_fem_us/mnnFormSubmit" 
          label_button="#rn:msg:SUBMIT_YOUR_QUESTION_CMD#" 
          on_success_url="/app/ask_confirm/#" 
