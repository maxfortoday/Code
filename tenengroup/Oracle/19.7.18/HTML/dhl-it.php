...
<div class="csp-wrapper"> <!-- csp-wrapper -->
  <div class="csp-teaser" style="margin-top: 20px;">
    <div>
    <p>Benvenuti!</p>
    <p class="csp-input-left">Si prega di inserire il numero di ordine e numero di telefono in modo da poterli dare allo spedizioniere per essere da loro contattati in fase di consegna della spedizione.
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-lang-wrap">
        <rn:widget path="input/SelectionInput" name="Incident.c$site" default_value="149" />
      </div>
      <!-- /LANG -->

<!-- EMAIL DHL@TENEGROUP.COM -->
      <div class="csp-input-full csp-email-ver" style="max-width: 400px;">
        <rn:widget path="input/FormInput" name="Contact.Emails.PRIMARY.Address" required="true" require_validation="false" label_input="#rn:msg:CUSTOM_MSG_Email_Verification_IT#" />
      </div>
<!-- /.EMAIL DHL@TENEGROUP.COM -->
      ...
      <div class="csp-submit" style="text-align: left; margin: 0; margin-left: 23px;">
        <rn:widget 
          ...
          label_button="SOTTOSCRIVI" 
          on_success_url="/app/dhl_confirm_it/#" 
