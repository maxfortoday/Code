...
<!--[if IE]>
  <link rel="stylesheet" type="text/css" href="ask-new-design-ie.css" />
<![endif]-->

<!-- rn:theme path="/euf/assets/themes/standard" css="ask-new-design-sg.css" / -->
...
<div class="csp-header">Email us</div>
  ...
  <ul class="csp-teaser-list">
    <li><span>You can also refer to our <a href="javascript: void(0);" onclick="window.top.location.href = 'https://www.mynamenecklace.sg/Article.aspx?p=5058&source=emailus';">FAQ</a> for quick answers for most questions.</span></li>
    <li><span>To follow up on your order, please visit the <a href="javascript: void(0);" onclick="window.top.location.href = 'https://www.mynamenecklace.sg/OrderTracking.aspx?source=emailus';">Order Tracking Information</a>.</span></li>
  </ul>
  <hr class="CShr">
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-lang-wrap">
        <rn:widget path="input/SelectionInput" name="Incident.c$site" default_value="26" />
      </div>
      <!-- /LANG -->
      ...
      <div class="csp-input-full csp-category">
        <rn:widget path="custom/input/CustomProductCategoryInput" name="Incident.Category" required_lvl="1" category_id_key="CUSTOM_CFG_CATEGORIES_LIST_SG"/>
      </div>
      <!-- /CATEGORY -->
