...
<div class="rn_Container">
  <div class="unsatisfied-box">
    <div class="unsatisfied-teaser">
      <div>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER1_FI#</div>
      <div>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER2_FI#</div>
    </div>
      ...
      <div class="order-late-inner">
        ...
        <label class="order-late-select" for="order-late-select-1">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT1_TITLE_FI#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT1_TEXT_FI#</div>
          </div>
        ...
        <label class="order-late-select" for="order-late-select-2">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT2_TITLE_FI#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT2_TEXT_FI#</div>
          </div>
          <div class="order-late-image-wrap">
        ...
        <label class="order-late-select" for="order-late-select-3">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT3_TITLE_FI#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT3_TEXT_FI#</div>
          </div>
          <div class="order-late-image-wrap">
            <img src="https://mnn.custhelp.com/euf/assets/themes/standard/images/order-necklace.png" />
          </div>
        </label>
        <strong>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER3_FI#</strong>
        <hr class="silver-border" />
        ...
        <form id="rn_QuestionSubmit1" method="post" action="/ci/ajaxRequest/sendForm">
          ...
          <div class="csp-input csp-email">
            <div class="teaser">#rn:msg:CUSTOM_MSG_ORDER_LATE_SUPPLIER_EMAIL_FI#</div>
          ...
          <div class="csp-input csp-order-id">
            <div class="teaser teaser-inline">#rn:msg:CUSTOM_MSG_ORDER_LATE_SUPPLIER_ORDER_ID_FI#</div>
            <div class="field-inline">
              <rn:widget 
          ...
          <div class="csp-submit-sates">
            <rn:widget path="input/FormSubmit" label_button="Lähetä kysymys" on_success_url="/app/thank-late-fi" error_location="rn_ErrorLocation" />
            <rn:condition content_viewed="2" searches_done="1">
            <rn:condition_else/>
            <rn:widget path="input/SmartAssistantDialog" label_prompt="#rn:msg:CUSTOM_MSG_SUBMIT_YOUR_QUESTION_CMD_FI#"/>
            </rn:condition>
          </div>
          <!-- /SUBMIT -->
        </form>
