    ...
    <form id="rn_QuestionSubmit1" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-input-full">
        <div class="contest-rules-wrap">
          <input id="contest-rules" class="contest-rules" type="checkbox" name="contest-rules" value="Yes" checked="checked"> <label for="contest-rules">I have read and agreed to the <a href="https://www.mynamenecklace.co.uk/article.aspx?p=9117" target="_blank">contest rules</a></label>
        </div>
      ...
      <div class="csp-submit-ugc">
        <rn:widget path="input/FormSubmit" label_button="SUBMIT" on_success_url="/app/thanks-ugc-uk" error_location="rn_ErrorLocation" />
