...
<style type="text/css">
  .order-late-text-wrap { width: 70%; }
  .order-late-image-wrap { width: 28%; }
</style>

<div class="rn_Container">
  <div class="unsatisfied-box">
    <div class="unsatisfied-teaser">
      <div>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER1_FEM_FR#</div>
      <div>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER2_FEM_FR#</div>
    </div>
      ...
      <div class="order-late-inner">
        ...
        <label class="order-late-select" for="order-late-select-1">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT1_TITLE_FEM_FR#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT1_TEXT_FEM_FR#</div>
          </div>
        ...
        <label class="order-late-select" for="order-late-select-2">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT2_TITLE_FEM_FR#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT2_TEXT_FEM_FR#</div>
          </div>
          <div class="order-late-image-wrap">
        ...
        <label class="order-late-select" for="order-late-select-3">
          <div class="order-late-text-wrap">
            <div class="order-late-ttl">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT3_TITLE_FEM_FR#</div>
            <div class="order-late-text">#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_OPT3_TEXT_FEM_FR#</div>
          </div>
          <div class="order-late-image-wrap">
            <img src="https://mnn.custhelp.com/euf/assets/themes/standard/images/order-necklace.png" />
          </div>
        </label>
        <strong>#rn:msg:CUSTOM_MSG_LATE_SUPPLIER_TEASER3_FEM_FR#</strong>
        <hr class="silver-border" />
        ...
        <form id="rn_QuestionSubmit1" method="post" action="/ci/ajaxRequest/sendForm">
          ...
          <div class="csp-input csp-email">
            <div class="teaser">#rn:msg:CUSTOM_MSG_ORDER_LATE_SUPPLIER_EMAIL_FEM_FR#</div>
          ...
          <div class="csp-input csp-order-id">
            <div class="teaser teaser-inline">#rn:msg:CUSTOM_MSG_ORDER_LATE_SUPPLIER_ORDER_ID_FEM_FR#</div>
            <div class="field-inline">
              <rn:widget 
