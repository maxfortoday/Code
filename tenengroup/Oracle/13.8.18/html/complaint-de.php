...
<div class="rn_Container">
  <div class="unsatisfied-box">
    <div class="unsatisfied-title">Es tut uns sehr leid, dass Sie mit Ihrer Bestellung nicht zufrieden sind. Lassen Sie uns gemeinsam eine L&ouml;sung finden, und w&auml;hlen Sie eine der folgenden Optionen aus:</div>
    <div class="unsatisfied-item">
        <input type="radio" name="unsatisfied-select" id="unsatisfied-select-1">
        <label for="unsatisfied-select-1" class="unsatisfied-item-label">Senden Sie das Schmuckst&uuml;ck an uns zur&uuml;ck und suchen Sie sich ein anderes Produkt aus. Wir schenken Ihnen zus&auml;tzlich EUR 20,-.<br>
            Zum Beispiel: Wenn Ihre urspr&uuml;ngliche Bestellung EUR 70,- ausgemacht hat, k&ouml;nnen Sie ein anderes Produkt f&uuml;r EUR 90,- aussuchen.</label>
              ...
              <div class="rn_PageContent rn_AskQuestion rn_Container container_notsetas1">
                <form id="rn_QuestionSubmit1" method="post" action="/ci/ajaxRequest/sendForm">
                  ...
                  <div class="csp-input csp-reorder-sku-link">
                    <div class="teaser">F&uuml;gen Sie den Link oder die Produkt ID hier ein:</div>
                    <div>
                    <rn:widget 
                    ...
                    <div class="teaser reorder-sku-bottom-teaser">Einer unser Kundendienstmitarbeiter wird sich mit Ihnen in Verbindung setzen <br />um Ihre Bestellung abzuschlie&szlig;en.</div>
                  </div>
                  <!-- reorder_sku_link -->

                  <!-- E-MAIL -->
                  <div class="csp-input csp-email">
                    <div class="teaser">Bitte geben Sie Ihre E-Mail Adresse ein:</div>
                  ...
                  <div class="csp-input csp-order-id">
                    <div class="teaser teaser-inline">Geben Sie Ihre Bestellnummer ein:</div>
                    <div class="field-inline">
                      <rn:widget 
                        path="input/FormInput" 
                  ...
                  <div class="csp-input csp-complaint csp-complaint1">
                    <div class="teaser">W&auml;hlen Sie den Grund Ihrer Unzufriedenheit:</div>
                    <div class="field-inline">
                      <select id="reason4incomplete1">
                        <option value="Select" selected>Auswahl</option>
                        <option value="Missing items">Fehlende/r Artikel/n</option>
                        <option value="Empty envelope">Leerer Umschlag</option>
                        <option value="Missing part">Fehlender Teil</option>
                        <option value="Sent wrong item">Falscher Artikel wurde gesendet</option>
                        <option value="Sent without gift box">Geschenkbox fehlt</option>
                        <option value="Sent without gift card">Geschenknachricht fehlt</option>
                        <option value="All lower case letters">Nur Kleinbuchstaben</option>
                        <option value="Don't like the font">Mag die Schriftart nicht</option>
                        <option value="Don't like product design">Mag das Produktdesign nicht</option>
                        <option value="Engaving not clear">Gravur nicht gut erkennbar</option>
                        <option value="Engaving too small">Gravur zu klein</option>
                        <option value="Looks cheap">Sieht billig aus</option>
                        <option value="Monogram font">Monogramm Schriftart</option>
                        <option value="Not as described on site">Nicht wie auf der Seite beschrieben</option>
                        <option value="Receiver didn't like the gift">Empf&auml;nger mochte das Geschenk nicht</option>
                        <option value="The size of the item">Die Gr&ouml;&szlig;e des Artikels</option>
                        <option value="Too thin">Zu d&uuml;nn</option>
                      </select>      
                    </div>
                    <!-- COMPLAINT -->
                  ...
                  <div class="csp-input csp-upload">
                    <div>Bitte f&uuml;gen Sie ein Bild des genannten Artikels bei:</div>
                    <div class="attachment-teaser"><strong>Foto hinzuf&uuml;gen</strong></div>
                    <div class="field-inline">
                  ...
                  <div class="csp-submit-sates">
                    <rn:widget path="input/FormSubmit" label_button="Absenden" on_success_url="/app/complaint-thank-de" error_location="rn_ErrorLocation" />
    ...
    <div class="unsatisfied-item">
        ...
        <label for="unsatisfied-select-2" class="unsatisfied-item-label">Sie erhalten eine R&uuml;ckerstattung von 10% von Ihrer urspr&uuml;nglichen Bestellung. </label>
        <div class="unsatisfied-item-form" style="max-width: 620px;">
    ...
    <div class="unsatisfied-item">
        ...
        <label for="unsatisfied-select-3" class="unsatisfied-item-label">Sie erhalten einen 50% Rabatt Gutschein f&uuml;r Ihren n&auml;chsten Einkauf. W&auml;hlen Sie hier den Anlass, den Sie feiern m&ouml;chten und wir werden Ihnen 45 Tage vorher Ihren Promo Code zusenden!</label>
        <div class="unsatisfied-item-form" style="max-width: 620px;">
              ...
              <div class="rn_PageContent rn_AskQuestion rn_Container container_notsetas1">
                <form id="rn_QuestionSubmit3" method="post" action="/ci/ajaxRequest/sendForm">
                  ...
                  <div class="csp-input csp-reorder">
                    <div class="teaser">Anlass</div>
                    <div class="field-inline">
                      <select id="coupon_reorder">
                        <option value="Select" selected>Auswahl</option>
                        <option value="Valentine">Valentinstag</option>
                        <option value="Mother's day">Muttertag</option>
