    ...
    <form id="rn_QuestionSubmit1" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-input-full">
        ...
        <div class="csp-ugc-upload">
         ...
         <div class="under-button-text">
            STYLE TIP: Make sure your jewellery is clear and focused
          </div>
        <!-- /FILE UPLAOD -->
      ...
      <div class="csp-input-full">
        <div class="contest-rules-wrap">
          <input id="contest-rules" class="contest-rules" type="checkbox" name="contest-rules" value="Yes" checked="checked"> <label for="contest-rules">I have read and agreed to the <a href="https://www.mynamenecklace.com/article.aspx?p=9117" target="_blank">contest rules</a></label>
        </div>
        ...
        <div class="offer-ends">
          <p>Send or tag your pictures before 21.08.2018 at midnight</p>
        </div>
      </div>
      ...
      <div class="csp-submit-ugc">
        <rn:widget path="input/FormSubmit" label_button="SUBMIT" on_success_url="/app/thanks-ugc-au" error_location="rn_ErrorLocation" />
