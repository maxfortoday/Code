...
<div class="csp-wrapper"> <!-- csp-wrapper -->
  ...
  <ul class="csp-teaser-list">
    <li><span>You can also refer to our <a href="https://www.mynamenecklace.com.au/Article.aspx?p=5058&source=emailus" target="_top">FAQ</a> for quick answers for most questions.</span></li>
    <li><span>To follow up on your order, please visit the <a href="https://www.mynamenecklace.com.au/OrderTracking.aspx?source=emailus" target="_top">Order Tracking Information</a>.</span></li>
  </ul>
  <hr class="CShr">
  ...
  <div class="rn_PageContent rn_AskQuestion rn_Container">
    <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
      ...
      <div class="csp-input-full csp-category">
        <rn:widget 
          path="custom/input_au/CustomProductCategoryInput" 
          name="Incident.Category" 
          required_lvl="1" 
          category_id_key="CUSTOM_CFG_CATEGORIES_LIST_AU"
        />
      </div>
...
<!-- /DAMAGED -->
      ...
      <div class="csp-input-left csp-phone">
        <rn:widget 
          path="custom/FormInput_au/mnnFormInput" 
      ...
      <div class="csp-input-right csp-state">
        <rn:widget 
          ...
          required="false" 
          label_input="#rn:msg:CUSTOM_MSG_STATE_AU#"/>
      ...
      <div class="csp-input-right csp-zip">
        <rn:widget 
          ...
          required="false" 
          label_input="#rn:msg:CUSTOM_MSG_ZIP_CODE_AU#"/>
...
?>
      ...
      <div class="csp-upload">
        <rn:widget 
      path="custom/FileAttachmentUpload_AU/CustomFileAttachmentUpload" 
      required="false" 
