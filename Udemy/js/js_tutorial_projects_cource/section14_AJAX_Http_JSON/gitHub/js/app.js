class GITHUB{
  constructor(){
    this.client_id = 'c15bab712706ea39b305';
    this.client_secret = 'c539c3ca8ebf818a7dae00ecfce7a748339785f7';
...
class UI{
  ...
  showUser(user) {
    ...
    if(message === 'Not Found') {
      this.showFeedback('No such user exists, please enter valid user');
    } else {
...
(function(){
  ...
  searchForm.addEventListener('submit',e=>{
    ...
    if(textValue === '') {
      ...
      github
        .ajaxUser(textValue)
        .then(data => ui.showUser(data.user))
